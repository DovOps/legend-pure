...
public class TestPureException
{
    ...
    {
        Assertions.assertArrayEquals(new SourceInformation[]{null}, new BasicPureException().getPureStackSourceInformation());
        ...
        Assertions.assertArrayEquals(new SourceInformation[] {sourceInfo1}, pureException1.getPureStackSourceInformation());

        PureException pureException2 = new BasicPureException(pureException1);
        Assertions.assertArrayEquals(new SourceInformation[] {sourceInfo1, null}, pureException2.getPureStackSourceInformation());
        ...
        Assertions.assertArrayEquals(new SourceInformation[] {sourceInfo1, null, sourceInfo2}, pureException3.getPureStackSourceInformation());
        ...
        Assertions.assertArrayEquals(new SourceInformation[] {sourceInfo1, null, sourceInfo2, sourceInfo3}, pureException4.getPureStackSourceInformation());
    }
    ...
    public void testFindPureException()
    {
        ...
        Assertions.assertSame(pureException1, PureException.findPureException(pureException1));

        PureException pureException2 = new BasicPureException(pureException1);
        Assertions.assertSame(pureException2, PureException.findPureException(pureException2));

        Assertions.assertSame(pureException1, PureException.findPureException(new RuntimeException(pureException1)));
        Assertions.assertSame(pureException2, PureException.findPureException(new RuntimeException(pureException2)));

        Assertions.assertSame(pureException1, PureException.findPureException(new IOException(new RuntimeException(new RuntimeException(pureException1)))));
        Assertions.assertSame(pureException2, PureException.findPureException(new IOException(new RuntimeException(new RuntimeException(pureException2)))));

        Assertions.assertNull(PureException.findPureException(new RuntimeException()));
    }
