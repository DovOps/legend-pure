...
public class HasSubsecondWithAtLeastPrecision extends NativePredicate
{
    public HasSubsecondWithAtLeastPrecision(FunctionExecutionInterpreted functionExecution, ModelRepository repository)
    {
        super(repository);
    }
